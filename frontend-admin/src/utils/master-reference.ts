...
export const MASTER_REFERENCE_RULES: Record<MasterResource, MasterReferenceRule[]> = {
  users: [
    ...
    { table: 'mold_development_project', column: 'owner_id', label: '模具开发负责人', domain: '模具开发' },
    { table: 'mold_development_project', column: 'created_by', label: '模具开发项目创建人', domain: '模具开发' },
    { table: 'mold_project_milestone', column: 'owner_id', label: '模具开发节点负责人', domain: '模具开发' },
    { table: 'mold_project_milestone', column: 'approved_by', label: '模具开发节点审批人', domain: '模具开发' },
    { table: 'mold_trial_detail', column: 'owner_id', label: '模具试模负责人', domain: '模具开发' },
    { table: 'mold_trial_detail', column: 'confirmed_by', label: '模具试模确认人', domain: '模具开发' },
    { table: 'mold_revision', column: 'created_by', label: '模具版本创建人', domain: '模具开发' },
    { table: 'mold_revision', column: 'approved_by', label: '模具版本审批人', domain: '模具开发' },
    { table: 'mold_attachment', column: 'uploaded_by', label: '模具附件上传人', domain: '模具开发' },
    { table: 'mold_cost_record', column: 'created_by', label: '模具成本登记人', domain: '模具开发' },
    { table: 'mold_supplier_evaluation', column: 'evaluated_by', label: '模具供应商评价人', domain: '模具开发' },
  ],
  warehouses: [
  ...
  products: [
    ...
    { table: 'mold_development_project', column: 'product_id', label: '模具开发项目', domain: '模具开发' },
    { table: 'mold_product', column: 'product_id', label: '模具产品穴位', domain: '模具开发' },
  ],
  customers: [
  ...
  suppliers: [
    ...
    { table: 'mold_development_project', column: 'supplier_id', label: '模具开发项目', domain: '模具开发' },
    { table: 'mold_component', column: 'supplier_id', label: '模具零件', domain: '模具开发' },
    { table: 'mold_cost_record', column: 'supplier_id', label: '模具成本', domain: '模具开发' },
    { table: 'mold_supplier_evaluation', column: 'supplier_id', label: '模具供应商评价', domain: '模具开发' },
  ],
  machines: [
  ...
  molds: [
    ...
    { table: 'mold_development_project', column: 'mold_id', label: '模具开发项目', domain: '模具开发' },
    { table: 'mold_revision', column: 'mold_id', label: '模具版本', domain: '模具开发' },
    { table: 'mold_attachment', column: 'mold_id', label: '模具附件', domain: '模具开发' },
    { table: 'mold_product', column: 'mold_id', label: '模具产品穴位', domain: '模具开发' },
    { table: 'mold_component', column: 'mold_id', label: '模具零件', domain: '模具开发' },
    { table: 'mold_cost_record', column: 'mold_id', label: '模具成本', domain: '模具开发' },
    { table: 'mold_supplier_evaluation', column: 'mold_id', label: '模具供应商评价', domain: '模具开发' },
