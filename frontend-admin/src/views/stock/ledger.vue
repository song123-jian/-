  ...
  <div class="page-container">
    ...
    <el-card shadow="hover">
      <el-table :data="tableData" stripe v-loading="loading" show-summary>
        ...
        <el-table-column prop="beginQty" label="期初数量" width="100" />
        <el-table-column prop="inQty" label="入库数量" width="100" />
        <el-table-column prop="outQty" label="出库数量" width="100" />
        <el-table-column prop="endQty" label="期末数量" width="100" />
...
async function fetchData() {
  loading.value = true
  try {
    const res: any = await getStockLedger({ page: pagination.page, pageSize: pagination.pageSize })
